...
static const sConsoleCommandTable_T mConsoleCommandTable[] =
{
	...
	{"led_toggle", &ConsoleCommandLEDToggle, HELP("Toggle a specified LED [0-7]: led_toggle 3")},
	{"led_blink", &ConsoleCommandLEDBlink, HELP("Blink a specified LED [0-7]: led_blink 3")},
